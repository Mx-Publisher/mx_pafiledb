 ...
 * -------------------------------------------------------------------------
 * 
 *    $Id: pa_search.php,v 1.13 2005/12/08 15:15:13 jonohlsson Exp $
 */
	...
	function main( $action )
	{
		...
		if ( isset( $_POST['submit'] ) || $search_author != '' || $search_keywords != '' || $search_id )
		{
			...
			if ( $search_results != '' )
			{
				...
				$base_url = append_sid( pa_this_mxurl( "action=search&amp;search_id=$search_id" ) );

				$pafiledb_template->assign_vars( array( 
					'PAGINATION' => generate_pagination( $base_url, $total_match_count, $pafiledb_config['pagination'], $start ),
		...
		if ( !isset( $_POST['submit'] ) || ( $search_author == '' && $search_keywords == '' && !$search_id ) )
		{
			...
			$pafiledb_template->assign_vars( array( 
				'S_SEARCH_ACTION' => append_sid( pa_this_mxurl() ),
				'S_CAT_MENU' => $dropmenu,
